...
public class Main {
    public static void main(String[] args) {
        ...
        List<Order> cityKiev= new ArrayList<Order>();
        for(Order o : orders){
            if (o.getUser().getCity()== "Kiev") cityKiev.add(o);
        }
        System.out.println(cityKiev);
        System.out.println("list of orders with city Odessa");
        List<Order> cityOdessa= new ArrayList<Order>();
        for(Order o : orders){
            if (o.getUser().getCity()== "Odessa") cityOdessa.add(o);
        }
        System.out.println(cityOdessa);
        System.out.println("list of orders with city Lviv");
        List<Order> cityLviv= new ArrayList<Order>();
        for(Order o : orders){
            if (o.getUser().getCity()== "Lviv") cityLviv.add(o);
        }
        System.out.println(cityLviv);


        System.out.println("list of orders with city Donezk");
        List<Order> cityDonezk= new ArrayList<Order>();
        for(Order o : orders){
            if (o.getUser().getCity()== "Donezk") cityDonezk.add(o);
        }
        System.out.println(cityDonezk);
